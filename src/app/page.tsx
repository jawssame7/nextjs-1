  ...
  return (
    <main>
      <div className={'bg-white pb-6 sm:pb-8 lg:pb-12'}>
        <div
          className={
            'max-w-screen-2xl px-4 md:px-8 mx-auto'
          }
        >
          <section
            className={
              'flex flex-col lg:flex-row justify-between gap-6 sm:gap-10 md:gap-16'
            }
          >
            <div
              className={
                'xl:w-5/12 flex flex-col justify-center sm:text-center md:text-left lg:py-12 xl:py-24'
              }
            >
              <p
                className={
                  'text-pink-500 md:text-lg xl:text-xl font-semibold mb-4 md:mb-6'
                }
              >
              ...
              <h1
                className={
                  'text-black-800 text-4xl sm:text-5xl md:text-6xl font-bold mb-8 md:mb-12'
                }
              >
              ...
              <p
                className={
                  'lg:w-4/5 text-gray-500 xl:text-lg leading-relaxed mb-4 md:mb-6'
                }
              >
                Learn about the new features of Next.js 13
                through building a note application.
              </p>
